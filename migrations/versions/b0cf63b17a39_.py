...
Revision ID: b0cf63b17a39
Revises: 
Create Date: 2023-11-06 09:57:54.464127
...
def upgrade():
    ...
    sa.Column('problemaEnfrentado_id', sa.UUID(), nullable=False),
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['problemaEnfrentado_id'], ['tb_problema_enfrentado.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['deficiencia_id'], ['tb_deficiencia.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('observacoesEducando_id', sa.UUID(), nullable=False),
    sa.Column('nis', sa.String(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['observacoesEducando_id'], ['tb_observacoes_educando.id'], ondelete='CASCADE'),
    ...
    sa.Column('pessoa_id', sa.UUID(), nullable=False),
    sa.Column('bolsaFamilia_id', sa.UUID(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['bolsaFamilia_id'], ['tb_bolsa_familia.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['condicaoMoradia_id'], ['tb_condicao_moradia.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['condicaoVida_id'], ['tb_condicao_vida.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['pessoa_id'], ['tb_pessoa.id'], ),
    sa.PrimaryKeyConstraint('pessoa_id')
    )
